...
function theme_scripts() {
	...
	wp_enqueue_style( 'theme-font',     'https://fonts.googleapis.com/css?family=Vollkorn', array(), $version );
	wp_enqueue_style( 'bxslider-style', 'https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.css', array( 'theme-reset' ), $version );
	...
	wp_enqueue_script( 'bxslider',     get_template_directory_uri() . '/js/bxslider.js',  array( 'jquery' ), $version );
